...
var piechart = function piechart() {
  __webpack_require__.e(/*! require.ensure | packages/piechart/piechart */ "packages/piechart/piechart").then((function () {
    return resolve(__webpack_require__(/*! @/packages/piechart/piechart.vue */ 19));
...
var _default = {
  ...
  mounted: function mounted() {
    this.initData(); // this.selectRadius = 180
  },
  methods: {
    initData: function initData() {
      var list = []; // this.random(5, 20)
    ...
    canvasScreenshot: function canvasScreenshot(canvasImg) {
      this.canvasImg = canvasImg;
    },
    touchPieChart: function touchPieChart(item, index) {
